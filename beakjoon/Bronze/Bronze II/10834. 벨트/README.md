# [벨트 [서브태스크]](https://www.acmicpc.net/problem/10834)

| 시간 제한 | 메모리 제한 | 제출 | 정답 | 맞힌 사람 | 정답 비율 |
| --- | --- | --- | --- | --- | --- |
| 1 초 | 256 MB | 6127 | 2532 | 2006 | 44.697% |
...
![image](https://onlinejudgeimages.s3-ap-northeast-1.amazonaws.com/problem/10834/1.png)
...
| 번호 | 배점 | 제한 |
| --- | --- | --- |
| 1 | 13 | 입력으로 주어지는 모든 벨트에 대해 a = b = 1이다. |
| 2 | 37 | 모든 벨트의 형태가 0으로 동일하다. |
| 3 | 50 | 원래의 제약조건 이외의 아무 제약 조건이 없다. |
